...
const Consultation =()=>{
      return (<>
        ...
        <Center  className="slidein-top revealOnce" fontFamily="goudy" fontSize="2.5rem" textAlign="center">REAL ESTATE CONSULTATION</Center>
        <Center  className="fadein revealOnce" fontFamily="avenir" fontSize="2.5rem" textAlign="center">OUR EXPERTISE, OUR PROSPERITY</Center>
        <Flex pt="1.125rem"> 
