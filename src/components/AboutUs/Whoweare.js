...
const Whoweare =()=>{
      ...
      <Flex direction="column" h="100vh">
        <Center fontFamily="goudy" fontSize="2.5rem">WHO WE ARE</Center>
        <Center fontSize="1rem">Prime LifeSpace, as the name suggests, is a pre-eminent real estate consultancy & development firm, with 30+ years of experience in the industry.<br/>
        ...
        <Flex overflow="hidden">
            <Flex direction="column" w="45%">
                ...
                <Flex direction="column">
                    <Heading fontSize="1.125rem" textAlign="center">
          ...
          >
            ...
            <Flex direction="column" w="45%">
                ...
                <Center><Icon></Icon></Center>
                <Flex direction="column">
                    <Heading fontSize="1.125rem" textAlign="center">INDIA'S MOST ADMIRED & IMPACTFUL<br/>
        ...
        <Flex>
            ...
            <Heading fontFamily="avenir" fontSize="1.125rem" textAlign="center">CHAIRMAN & MANAGING DIRECTOR</Heading>
                    ...
                    <Icon
                        ...
                        h="3.125rem"
                        color="#DFBD69" />
                    We EXCEL in boosting livability quotient, attract global fund & investors & create positive impact on society that endeavors
                    <Icon
                        pos="absolute"
                        right="0"
                        bottom="-50%"
            ...
            <Image w="448px" h="404px" alt="IMAGE"/>
        </Flex>
        </Flex>
      </>)
}
