...
const Whoweare =()=>{
      return (<>
      <Flex h="100%" direction="column" bgImage='linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url("/images/bg-box.jpg")'
            bgRepeat="no-repeat"
            bgPos="center"
            bgSize="cover">
      <Flex><Image opacity="0" h="2.5rem" w="100%"/></Flex>
      <Flex direction="column" overflow="hidden" px="1rem" pt="2.5rem">
        ...
        <Flex direction="column" overflow="hidden" pb="5rem" >
            <Flex direction="column" w="100%" className="fadein-2sdelay revealOnce">
            ...
            <Flex className="fadein-2sdelay revealOnce" direction="column" w="100%">
        ...
        <Flex direction="column" pos="relative" pb="5rem">
        <Image className="image-sliedright reveal" src={rajeev} w="448px" h="404px" alt="IMAGE"/>
            ...
            <Heading pb="1.125rem" fontFamily="avenir" fontSize="1.125rem" textAlign="center">CHAIRMAN & MANAGING DIRECTOR</Heading>    
                    <Text mt="2rem" pos="relative" fontSize="1rem" textAlign="center" >
                    <Icon
                        pos="absolute"
                        left="0"
                        top="-50%"
