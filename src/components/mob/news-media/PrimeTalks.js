import { Flex, Text, Divider, Box, Heading } from "@chakra-ui/react";
    ...
    >
      ...
      <Flex direction="column" w="100%" h="100%" align="flex-start" justify="flex-start" pt="1.875rem">
        ...
        <Flex direction="column">
          ...
          {/*<Flex mt="1rem" gap="0.625rem" w="100%" h="100%">
        
        <button style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===0?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===1?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===2?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===3?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button onClick={()=>{slider.slickGoTo(0);setCurrentSlide(0)}} style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===0?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button onClick={()=>{slider.slickGoTo(1);setCurrentSlide(1)}} style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===1?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button onClick={()=>{slider.slickGoTo(2);setCurrentSlide(2)}} style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===2?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
        <button onClick={()=>{slider.slickGoTo(3);setCurrentSlide(3)}} style={{height:"1rem",width:"1rem",backgroundColor:currentSlide===3?"#DFBD69":"#bbb",borderRadius:"50%",}}/>
  </Flex>*/}
        </Box>
        </Flex>
      </Flex>
